...
class CustomTextField: UITextField {
    ...
    init(text: String, placeholder : String, size: CGFloat, weight: UIFont.Weight = .regular, alignment: NSTextAlignment = .left, textColor: UIColor = .black, canEdit: Bool = true) {
